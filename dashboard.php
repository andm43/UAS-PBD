...
// Mengambil total jumlah departemen
$totalDepartemen = $conn->query("SELECT COUNT(*) AS total FROM departemen")->fetch_assoc()['total'];
...
// Mengambil distribusi jumlah karyawan per jabatan (ENUM)
